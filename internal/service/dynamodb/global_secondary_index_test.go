		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					testAccCheckInitialGSIExists(ctx, resourceNameGSI, &conf, &gsi),
...
func testAccCheckInitialGSIExists(_ context.Context, n string, tbl *awstypes.TableDescription, gsi *awstypes.GlobalSecondaryIndexDescription) resource.TestCheckFunc {
